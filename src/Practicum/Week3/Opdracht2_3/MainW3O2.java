...
public class MainW3O2 {
    public static void main(String[] args) {
        ...
        /* Opdracht 3 */
        Game P1heeftG1 = p1.zoekGameOpNaam("Just Cause 3");
        System.out.println("p1 heeft Just Cause 3 "+(P1heeftG1 != null ? "wel!" : "niet!"));

        Game P3heeftG1 = p3.zoekGameOpNaam("Just Cause 3");
        System.out.println("p3 heeft Just Cause 3 "+(P3heeftG1 != null ? "wel!" : "niet!"));
    }
}
